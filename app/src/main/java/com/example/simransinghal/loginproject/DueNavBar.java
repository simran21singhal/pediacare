...
public class DueNavBar extends Fragment {
    Fragment fragment;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.due_vacc_list, container, false);
    ...
    public void getDueVaccObj() {
        String method = "getUpcomingChildVaccineList";
            ...
            public void onSuccess(JSONObject result) {
                try {
                    ...
                    if (result.has("data")) {
                        ...
                        DueAdapter adapter = new DueAdapter(inflater, vacc, child, due_on);
